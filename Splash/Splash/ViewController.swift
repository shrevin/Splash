...
class ViewController: UIViewController {
    ...
    var responseCode: String? {
        didSet {
            // once we set a response code, we get access token
            fetchAccessToken { (dictionary, error) in
                ...
                DispatchQueue.main.async {
                    // set access token on our appRemote configuration
    ...
    lazy var configuration: SPTConfiguration = {
        // sessionManager contains configuration below that Spotify needs to know how to talk back to us
    ...
    @objc func didTapConnect(_ button: UIButton) {
        guard let sessionManager = sessionManager else { return } // instantiating a session manager
...
extension ViewController: SPTAppRemoteDelegate {
    ...
    func appRemoteDidEstablishConnection(_ appRemote: SPTAppRemote) {
        // once connected, we update the view
        updateViewBasedOnConnected()
